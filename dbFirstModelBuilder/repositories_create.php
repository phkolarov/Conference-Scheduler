...
KUF;
    ...
    $content = "";
    $content .= "<?php\n";
    $content .= "namespace SoftUni\\Repositories;\n";
    $content .= "\n";
    $content .= "use SoftUni\\Core\\Database;\n";
    $content .= "use SoftUni\\Models\\$model;\n";
    $content .= "use SoftUni\\Collections\\$model" . "Collection" . ";\n\n";
...
$columnFilters
    ...
    {
        \$refc = new \ReflectionClass('\SoftUni\\$model');
